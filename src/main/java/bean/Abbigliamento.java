...
public class Abbigliamento {
	...
	public Abbigliamento(String nome,String tipo ,String descrizone,String colore,String taglia, double prezzo) {
		this.nome=nome;
	...
	public Abbigliamento(String nome,String tipo ,String descrizone,String colore) {
		this.nome=nome;
		this.descrizione=descrizone;
		this.colore=colore;
	}
