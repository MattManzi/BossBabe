...
@WebServlet("/VisualizzaMagliaControl")
public class VisualizzaMaglCamTopControl extends HttpServlet{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		System.out.println("Catalogo Magia top....");
		AbbigliamentoModel am = new AbbigliamentoModel();

		String redirectedPage = "/HomePage.jsp";

		try {
			ArrayList<Abbigliamento> a = am.findAllMaglia("");
