...
@WebServlet("/VisualizzaPantaloniControl")

public class VisualizzaPantaloniControl extends HttpServlet{
	private static final long serialVersionUID = 1L;
	public VisualizzaPantaloniControl() {
	super();
	}
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			ArrayList<Abbigliamento> a = am.findAllPantaloni("");
