...
@WebServlet("/VisualizzaShortControl")

public class VisualizzaShortControl extends HttpServlet{
	private static final long serialVersionUID = 1L;
	
	public VisualizzaShortControl() {
	super();
	}
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			ArrayList<Abbigliamento> a = am.findAllShort("");
