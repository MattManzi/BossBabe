...
@WebServlet("/VisualizzaNuoviArriviControl")
public class VisualizzaNuoviArriviControl extends HttpServlet{
	private static final long serialVersionUID = 1L;
	
	public VisualizzaNuoviArriviControl() {
	super();
	}
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		System.out.println("Catalogo abbigliamento");
		AbbigliamentoModel am = new AbbigliamentoModel();

		String redirectedPage = "/HomePage.jsp";

		try {
			ArrayList<Abbigliamento> a = am.findAllNuoviArrivi("");
