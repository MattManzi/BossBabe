...
@WebServlet("/VisualizzaDressControl")
public class VisualizzaDressControl extends HttpServlet{
	private static final long serialVersionUID = 1L;
	
	public VisualizzaDressControl() {
	super();
	}
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			ArrayList<Abbigliamento> a = am.findAllDress("");
