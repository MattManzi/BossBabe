...
@WebServlet("/VisualizzaCatalogoAbbigliamentoControl")
public class VisualizzaCatalogoAbbigliamentoControl extends HttpServlet {
	private static final long serialVersionUID = 1L;

	public VisualizzaCatalogoAbbigliamentoControl() {
		super();
	}
