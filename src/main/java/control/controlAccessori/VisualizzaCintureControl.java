...
@WebServlet("/VisualizzaCintureControl")
public class VisualizzaCintureControl extends HttpServlet{
	private static final long serialVersionUID = 1L;

	public VisualizzaCintureControl() {
	super();
	}
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			ArrayList<Accessori> a = am.findAllCinture("");
